...
import InternshipA from './blocks/Internship/InternshipA';
import VolunteeringA from './blocks/Volunteering/VolunteeringA';
import GroupsA from './blocks/Groups/GroupsA';

const Blocks = {
  objective: ObjectiveA,
  work: WorkA,
  internship: InternshipA,
  volunteering: VolunteeringA,
